...
// Get All Branches with Pagination, Search, and Filtering
export const getAllBranches = async (req, res) => {
  try {
    ...
    res.status(500).json({ success: false, message: "Something went wrong while fetching branches", error: err.message });
  }
};
