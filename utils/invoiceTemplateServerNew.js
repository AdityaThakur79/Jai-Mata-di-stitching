          ...
          safeData.shippingDetails ? 
            React.createElement(View, { style: [styles.shippingSection, styles.cardFixed] },
              ...
              React.createElement(Text, { style: styles.shippingContent },
                safeData.shippingDetails.shippingAddress && `${safeData.shippingDetails.shippingAddress}\n`,
                safeData.shippingDetails.shippingCity && safeData.shippingDetails.shippingState && 
                  `${safeData.shippingDetails.shippingCity}, ${safeData.shippingDetails.shippingState}`,
                safeData.shippingDetails.shippingPincode && ` - ${safeData.shippingDetails.shippingPincode}`,
                safeData.shippingDetails.shippingPhone && `\nPhone: ${safeData.shippingDetails.shippingPhone}`,
                safeData.shippingDetails.shippingMethod && `\nMethod: ${safeData.shippingDetails.shippingMethod.replace('_', ' ').toUpperCase()}`,
                safeData.shippingDetails.deliveryStatus && `\nStatus: ${safeData.shippingDetails.deliveryStatus.replace('_', ' ').toUpperCase()}`
              )
            ) : null
        ),
