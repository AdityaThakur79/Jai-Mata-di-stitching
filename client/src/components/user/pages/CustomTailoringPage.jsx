...
const CustomTailoringPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-yellow-50 to-orange-50 pt-2 md:pt-0 relative">
      ...
      <div className="relative h-[40vh] sm:h-[45vh] md:h-[50vh] lg:h-[70vh] flex items-center justify-center text-center text-white overflow-hidden mb-8 sm:mb-12 mt-[100px] sm:mt-[110px] md:mt-[120px]">
        <div
