    ...
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-amber-50 to-orange-50 relative">
      ...
      <div className="relative h-[40vh] sm:h-[45vh] md:h-[50vh] lg:h-[60vh] flex items-center justify-center text-center text-white overflow-hidden mb-8 sm:mb-12 mt-[100px] sm:mt-[110px] md:mt-[120px]">
        <div
          ...
          style={{ backgroundImage: "url('/images/menspage.png')" }}
        />
        ...
        >
          <ol className="flex items-center space-x-1 sm:space-x-2 text-xs sm:text-sm md:text-base">
            ...
            <li className="text-amber-200 font-semibold">Men's</li>
          </ol>
        </nav>
        <motion.div
        ...
        >
          ...
          >
            Crafted Elegance for the Modern Gentleman
          </motion.h1>
          <motion.p
          ...
          >
            Discover timeless menswear rooted in heritage tailoring, reimagined
            for today's refined style.
          </motion.p>
        </motion.div>
      </div>
            ...
            items.map((item, index) => (
              <BlurFade key={item._id} delay={0.2 + index * 0.07}>
                ...
                >
                  ...
                  <button
                    className="absolute top-2 sm:top-3 right-2 sm:right-3 z-30 p-2 sm:p-2.5 bg-white/90 hover:bg-amber-100 border border-amber-200 rounded-full shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-amber-400 focus:ring-offset-2 transition-all duration-300 backdrop-blur-sm"
                    onClick={(e) => {
                      e.stopPropagation();
                      setModalImages(
