...
const MensWear = () => {
  ...
  // Fetch men's items
  const { data, isLoading, isError } = useGetAllItemMastersQuery({ page, limit, search, category: 'men' });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-amber-50 to-orange-50 pt-20 relative">
      {/* Overlays */}
        ...
        <div className="flex flex-col md:flex-row gap-4 items-center justify-between mb-8">
          ...
          <div className="flex items-center space-x-4">
            ...
            <select
              ...
              className="py-2 px-3 border border-gray-300 rounded-lg focus:border-black focus:ring-black"
            >
              {[8, 16, 24, 32].map(n => (
