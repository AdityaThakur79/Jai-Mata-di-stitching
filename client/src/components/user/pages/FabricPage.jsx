...
const FabricPage = () => {
  ...
  let filteredFabrics = staticFabrics.filter((fabric) => {
    ...
    const matchesPrice =
      fabric.price >= priceRange[0] && fabric.price <= priceRange[1];
    const matchesSearch = fabric.name
      .toLowerCase()
          ...
          >
            <div className="flex items-center space-x-3">
              <Checkbox
                ...
                onCheckedChange={() =>
                  onValueChange(item.value === selectedValue ? "" : item.value)
                }
    ...
    <div className="min-h-screen relative">
      ...
      <div className="relative h-[40vh] sm:h-[45vh] md:h-[50vh] lg:h-[60vh] flex items-center justify-center text-center text-white overflow-hidden mb-8 sm:mb-12 mt-[80px]">
        ...
        >
          <ol className="flex items-center space-x-1 sm:space-x-2 text-xs sm:text-sm md:text-base">
            ...
            <li className="text-amber-200 font-semibold">Fabrics</li>
          </ol>
        </nav>
        <motion.div
        ...
        >
          ...
          >
            Handpicked Fabrics, Tailored to Perfection
          </motion.h1>
          <motion.p
          ...
          >
            Explore a curated selection of premium fabrics chosen for elegance,
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-8">
        {/* <div className="text-center mb-6 md:mb-8 animate-pulse">
          <svg
            className="w-14 h-14 md:w-18 md:h-18 mx-auto text-amber-600"
            viewBox="0 0 100 100"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
              d="M20 40 L30 20 L50 10 L70 20 L80 40 L70 60 L50 70 L30 60 Z"
              stroke="currentColor"
              strokeWidth="2"
              fill="none"
            />
            ...
            <path
              d="M40 50 L60 50 M45 55 L55 55 M42 60 L58 60"
              stroke="currentColor"
              strokeWidth="1.5"
            />
          </svg>
        ...
        <div className="flex items-center justify-center mb-10 md:mb-16">
          <div className="flex-1">
            <h2 className="text-xs font-bold text-amber-600 tracking-[0.2em] uppercase mb-3 md:mb-4 font-serif animate-fadeInUp text-center">
              CURATED LUXURY COLLECTION
            </h2>

            <h1
              className="text-3xl xs:text-4xl md:text-5xl lg:text-6xl font-light text-gray-900 mb-3 md:mb-4 font-serif leading-tight animate-fadeInUp text-center"
              style={{ animationDelay: "0.2s" }}
            >
              Exquisite Premium Fabrics
            </h1>

            <div
              className="flex justify-center mb-4 md:mb-6 animate-fadeInUp"
            ...
            {/* <p
              className="text-gray-600 italic  font-light leading-relaxed animate-fadeInUp text-center"
              style={{ animationDelay: "0.6s" }}
            >
              "Discover our handpicked selection of the world's finest textiles,
              where artistry meets excellence in every thread"
            </p> */}
          </div>
        </div>
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-gray-600">
                Discover our curated collection of luxury textiles
              </p>
            </div>
        ...
        <div className="flex gap-8">
          ...
          {showFilters && (
            <div
              className="fixed inset-0 z-50 flex items-start justify-end bg-black/40 lg:hidden"
              style={{ top: "80px" }}
              onClick={() => setShowFilters(false)}
            >
              <aside
                className="w-full h-[calc(100vh-80px)] bg-white border-l border-gray-200 p-2 overflow-y-auto relative animate-slideInRight"
                style={{
                  width: "100vw",
                  maxWidth: "100vw",
                  minWidth: 0,
          ...
          <aside
            className={`hidden lg:block w-80 bg-white border border-gray-200 p-6 sticky top-8 h-fit transition-all duration-300`}
          >
            <div className="mb-6">
          ...
          <main className="flex-1">
            <div className="mb-6">
              <p className="text-sm text-gray-600">
                Showing {paginatedFabrics.length} of {filteredFabrics.length}{" "}
                fabrics
              </p>
            </div>
              ...
              {paginatedFabrics.length === 0 ? (
                ...
                paginatedFabrics.map((fabric, index) => (
                  ...
                  >
                    ...
                    {/* Content */}
                    <div
                      className={`${viewMode === "list" ? "flex-1" : "p-5"}`}
                    >
                      <div className="mb-3">
              ...
              >
                <Pagination>
                  <PaginationContent>
                    ...
                    {Array.from({ length: Math.min(totalPage, 5) }).map(
                      (_, i) => {
