...
import { PlusCircle, Trash, Loader2, Package, Upload, Scissors } from "lucide-react";
    ...
    <div className="min-h-screen py-4 px-2 sm:px-4">
      <div className="container mx-auto">
        ...
        <div className="mb-4">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-1">Create Item Master</h1>
          <p className="text-gray-600 text-sm">Define item type, measurement fields, and styles</p>
        </div>
